...
; Veți întoarce coada actualizată.
;aparent functia nu vrea sa intoarca nimic in afara de actualizarea left-right
;din cate inteleg se ocupa top de extragere
;dc left e gol se adauga la left ce e deja adaugat in right in varianta reversed
;right ramane evident gol in acest caz
;altfel - se extrage si arunca cdr aplicat pe left
(define (dequeue q)
